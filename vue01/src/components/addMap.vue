...
<script>
  import Vue from "vue"
    export default {
      ...
      methods:{
        addressDetail(){
             Vue.axios.get("https://elm.cangdu.org/v1/users/",{params:{user_id:1,address :this.dizhi,address_detail:this.address_detail,geohash:'34.751132'+","+ '113.68174',name:this.name,phone:this.phone,tag:'家',sex:'男',phone_bk :this.phone_bk,tag_type:"公司"}}).then(function (reslut) {
