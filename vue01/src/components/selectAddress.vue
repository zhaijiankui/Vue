      ...
      <table border="1" cellpadding="1" cellspacing="1" class="selectul">
        ...
        <tr>
          ...
          <td class="selectinput">
            <span class="iconfont span111">&#xe66a;</span>先生
            <span class="iconfont span112">&#xe66a;</span>女士
          </td>
        </tr>
        <tr>
        ...
        <tr v-if="show">
          <td class="selectspan"></td>
          <td class="selectinput">
            <input type="text" placeholder="备用电话">
          </td>
        </tr>
        <tr>
          <td class="selectspan">送餐地址</td>
          <td class="selectinput">
            <input type="text" placeholder="较好的风格" v-model="scan">
          </td>
        </tr>
        <tr>
          <td class="selectspan"></td>
        ...
        delet(){
         this.$http({
           ...
           data:{
             ...
             geohash:'34.751132'+","+ '113.68174',              name:this.name,
             phone:this.phone,
             tag:this.home,
             sex:'男士',
             tag_type:"公司"
