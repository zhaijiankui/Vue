...
<div class="a" ref="modality">
    <div class="child">
      ...
      <!--商品列表项-->
      <div class="splieb" @click="addAttr(value)" v-for="value in data">
      ...
      mounted(){
        ...
        methods:{
          ...
          addAttr(value){
            ...
            this.$router.push({path:'/child3',query:{names:this.index.image_path,name1:this.index.name,name2:this.index.float_delivery_fee,name3:this.index.order_lead_time,name4:this.index.id}})
          }
        }
    }
</script>
